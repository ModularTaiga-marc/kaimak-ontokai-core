...
async function generateSemanticLayer() {
    ...
    if (isVersionB) {
        console.log('🎯 Version B detected - skipping wizard API, loading interactive graph directly');
...
async function generateRegulationBusinessTerms(regName, regulationContext) {
    ...
    spinnerDiv.innerHTML = showSpinner(`🧠 Inferring ${regName} business terms...`);
